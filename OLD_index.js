...
// ЗАПРОС НА ПРИКРУТЬ БЕКЕНД

// Слушай а сможем с тобой прикрутить какой-нибудь простенький бекенд? а то у меня бот пока просто консультационный, а хотелось бы отслеживание выпускаемых карт с балансом и прочим. для отслеживания баланса нужна авторизация через метамаск, т.к. сервис выпускающий эти карты он через крипту работает.
